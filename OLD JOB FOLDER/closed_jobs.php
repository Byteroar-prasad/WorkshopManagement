                                    ...
                                    <table class="table table-hover table-vcenter table-striped" cellspacing="0" id="closedjobsTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td><a href="finish_job_card.php?j=<?php echo base64_encode($row[0]); ?>" style="color: #000;"><?php echo $row[10]; ?></a></td>
                                                ...
                                                <td><a href="finish_job_card.php?j=<?php echo base64_encode($row[0]); ?>" style="color: #000;"><?php echo $row[11]; ?></a></td>
